USE [cnx]
GO
/****** Object:  StoredProcedure [dbo].[usp_GetAdvancedTransactionForCustomerForWeb]    Script Date: 2017/11/14 10:25:19 ******/
SET ANSI_NULLS ON
GO
  ...
  WITH PageNumbers AS(
      ...
      FROM
        ...
        (SELECT
		   ...
		   CASE
           WHEN v.IssuedByCustomerId = @customerId AND v.AssetTypeId = 8 THEN at.A_Balance
           WHEN v.RedeemedByCustomerId = @customerId AND v.AssetTypeId = 8 THEN at.B_Balance
           ELSE null
           END
             AS 'SHL Balance',

		   CASE
           WHEN v.IssuedByCustomerId = @customerId AND v.AssetTypeId = 9 THEN at.A_Balance
           WHEN v.RedeemedByCustomerId = @customerId AND v.AssetTypeId = 9 THEN at.B_Balance
           ELSE null
           END
             AS 'BCC Balance',

		   CASE
           WHEN v.IssuedByCustomerId = @customerId AND v.AssetTypeId = 10 THEN at.A_Balance
           WHEN v.RedeemedByCustomerId = @customerId AND v.AssetTypeId = 10 THEN at.B_Balance
           ELSE null
           END
             AS 'ZEC Balance',

		   CASE
           WHEN v.IssuedByCustomerId = @customerId AND v.AssetTypeId = 11 THEN at.A_Balance
           WHEN v.RedeemedByCustomerId = @customerId AND v.AssetTypeId = 11 THEN at.B_Balance
           ELSE NULL
           END
             AS 'DRG Balance',

		   CASE
           WHEN v.IssuedByCustomerId = @customerId AND v.AssetTypeId = 13 THEN at.A_Balance
           WHEN v.RedeemedByCustomerId = @customerId AND v.AssetTypeId = 13 THEN at.B_Balance
           ELSE NULL
           END
             AS 'BTG Balance',
         ...
         SELECT
		   ...
		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 8 THEN at.A_Balance
           ELSE null
           END
             AS 'SHL Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 9 THEN at.A_Balance
           ELSE null
           END
             AS 'BCC Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 10 THEN at.A_Balance
           ELSE null
           END
             AS 'ZEC Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 11 THEN at.A_Balance
           ELSE null
           END
             AS 'DRG Balance',
		   
		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 13 THEN at.A_Balance
           ELSE null
           END
             AS 'BTG Balance',
         ...
         SELECT
		   ...
		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 8 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'SHL Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 9 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'BCC Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 10 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'ZEC Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 11 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'DRG Balance',

		   CASE
           WHEN tr.CustomerId = @customerId AND tr.AssetTypeId = 13 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'BTG Balance',
         ...
         SELECT
           ...
           CASE 
		   WHEN o.WantAssetTypeId = 1 then at.A_Balance 
		   WHEN o.OfferAssetTypeId = 1 then at.A_CNYBalance 
		   end 
		     AS 'CNY Balance',

           CASE
           WHEN o.WantAssetTypeId = 2 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 2 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'BTC Balance',
		   ...
		   WHEN o.OfferAssetTypeId = 6 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'ETC Balance',
		   ...
		   --when o.offerAssetTypeId = 2 then at.A_Balance
           ELSE null
           END
             AS 'SKY Balance',
		   
		   CASE
           WHEN o.WantAssetTypeId = 8 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 8 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'SHL Balance',

		   CASE
           WHEN o.WantAssetTypeId = 9 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 9 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'BCC Balance',

		   CASE
           WHEN o.WantAssetTypeId = 10 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 10 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'ZEC Balance',

		   CASE
           WHEN o.WantAssetTypeId = 11 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 11 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'DRG Balance',

		   CASE
           WHEN o.WantAssetTypeId = 13 THEN at.A_Balance
		   WHEN o.OfferAssetTypeId = 13 THEN at.A_CNYBalance
           ELSE null
           END
             AS 'BTG Balance',
         ...
         SELECT
           ...
           CASE 
		   WHEN o.WantAssetTypeId = 1 then at.B_CNYBalance 
		   WHEN o.OfferAssetTypeId = 1 then at.B_Balance 
		   end 
		     AS 'CNY Balance',

           CASE
           WHEN o.OfferAssetTypeId = 2 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 2 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'BTC Balance',

           CASE
           WHEN o.OfferAssetTypeId = 5 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 5 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'ETH Balance',
		   ...
		   WHEN o.WantAssetTypeId = 6 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'ETC Balance',
		   ...
		   WHEN o.WantAssetTypeId = 7 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'SKY Balance',

		   CASE
           WHEN o.OfferAssetTypeId = 8 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 8 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'SHL Balance',

		   CASE
           WHEN o.OfferAssetTypeId = 9 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 9 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'BCC Balance',

		   CASE
           WHEN o.OfferAssetTypeId = 10 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 10 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'ZEC Balance',

		   CASE
           WHEN o.OfferAssetTypeId = 11 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 11 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'DEG Balance',

		   CASE
           WHEN o.OfferAssetTypeId = 13 THEN at.B_Balance
		   WHEN o.WantAssetTypeId = 13 THEN at.B_CNYBalance
           ELSE null
           END
             AS 'BTG Balance',
