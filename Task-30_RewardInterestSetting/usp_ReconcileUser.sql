USE [cnx]
GO
/****** Object:  StoredProcedure [dbo].[usp_reconcileUser]    Script Date: 2018/03/28 14:49:43 ******/
SET ANSI_NULLS ON
GO
...
left join OrderBook O with(nolock) on T.B_OrderId = O.OrderId 
where O.CustomerId = @CustomerId and O.OrderTypeId = 2 and OfferAssetTypeId = 1176
----------------------------------------------------------------------------------------------------------------------------------------------
--FUN
