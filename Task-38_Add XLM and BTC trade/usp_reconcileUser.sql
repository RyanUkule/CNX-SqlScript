...
select @UsedLTC = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 3
...
select @UsedZEC = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 10
...
select @UsedFCABS = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 14
...
select @UsedDASH = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 16
...
select @UsedZRX = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 17
...
select @UsedFUN = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 18
...
select @UsedTNB = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 19
...
select @UsedETP = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 20
...
select @UsedUCASH = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 21
...
select @UsedCCOIN = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 22
...
select @UsedOMG = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 23
...
select @UsedRCN = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 24
...
select @UsedXRP = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 25
...
select @UsedEOS = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 26
...
select @UsedWAX = isnull(SUM(value),0) from Voucher with(nolock) where IsRedeemed = 1 and IssuedByCustomerId = @CustomerId and AssetTypeId = 28
...
, @CurrentEOS decimal(18, 8), @CurrentWAX decimal(18, 8)
